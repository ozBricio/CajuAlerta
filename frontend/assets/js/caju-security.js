// Caju Security - Sistema Anti-Robô Dinâmico (Semântico e Preciso)
const CajuSecurity = {
  attempts: 0,
  maxAttempts: 3,
  
  challenges: [{"text": "O local perfeito para pegar um bronzeado", "targets": ["🏖️", "🏝️", "☀️"], "decoys": ["🏔️", "🏙️", "🌋", "🏕️", "🛤️", "🏭", "🏥", "🏰", "🗽"]}, {"text": "Veículo que possui apenas 2 rodas", "targets": ["🏍️", "🚲", "🛵"], "decoys": ["🚗", "🚌", "🚕", "🚓", "🚑", "🚜", "🚛", "🚂", "🚁"]}, {"text": "Animal que sabe voar", "targets": ["🦅", "🦜", "🦇"], "decoys": ["🐶", "🐱", "🐢", "🐍", "🐘", "🐅", "🦍", "🐊", "🐫"]}, {"text": "Objeto usado para cortar coisas", "targets": ["✂️", "🔪", "🗡️"], "decoys": ["🖊️", "📏", "📎", "📚", "🧲", "🖌️", "🖍️", "📦", "📱"]}, {"text": "Alimento doce que serve como sobremesa", "targets": ["🍫", "🍰", "🍩"], "decoys": ["🥦", "🧅", "🥩", "🥚", "🌶️", "🧀", "🍗", "🥬", "🥕"]}, {"text": "O que você usaria em um dia de muita chuva", "targets": ["☂️", "☔", "🧥"], "decoys": ["🕶️", "🧢", "🧣", "🩳", "🩴", "🎒", "👑", "⌚", "💍"]}, {"text": "Lugar ou objeto onde se guarda dinheiro", "targets": ["🏦", "👛", "🪙"], "decoys": ["🗑️", "🚽", "🛁", "🚪", "🪟", "🪑", "🛏️", "🛋️", "📺"]}, {"text": "Objetos usados no banho ou encontrados no banheiro", "targets": ["🚿", "🛁", "🧼"], "decoys": ["🚗", "💻", "⚽", "🎸", "📱", "📺", "🛏️", "📚", "🌲"]}, {"text": "O que você abre de manhã ao acordar", "targets": ["🚪", "🪟", "👁️"], "decoys": ["📦", "🗑️", "🔪", "🔫", "💣", "🪓", "🧨", "🗡️", "🛡️"]}, {"text": "Onde você joga lixo", "targets": ["🗑️", "🚮", "🗑️"], "decoys": ["🛏️", "🛋️", "🛁", "🚿", "📺", "📻", "📱", "💻", "🖨️"]}, {"text": "Algo que ilumina a noite", "targets": ["💡", "🔦", "🕯️"], "decoys": ["🌑", "📱", "💻", "📺", "🪟", "🚪", "🪑", "🛏️", "🛋️"]}, {"text": "O que você usa para ver as horas", "targets": ["⌚", "⏰", "🕰️"], "decoys": ["📱", "💻", "📺", "📻", "🖨️", "🖱️", "🖲️", "🕹️", "🗜️"]}, {"text": "Animal de estimação comum em casa", "targets": ["🐶", "🐱", "🐹"], "decoys": ["🦁", "🐯", "🐻", "🐘", "🦏", "🦍", "🐅", "🐆", "🦓"]}, {"text": "Algo que fazemos no inverno para esquentar", "targets": ["☕", "🔥", "🧣"], "decoys": ["🍦", "🧊", "🥤", "🍉", "🏖️", "🏝️", "🩳", "🩴", "👕"]}, {"text": "Instrumento musical que tem cordas", "targets": ["🎸", "🎻", "🪕"], "decoys": ["🥁", "🎺", "🎷", "🪈", "🎹", "🎙️", "🎚️", "🎛️", "🎤"]}, {"text": "Algo usado para viajar pelo céu", "targets": ["✈️", "🚁", "🚀"], "decoys": ["🚗", "🚌", "🚕", "🚓", "🚑", "🚜", "🚛", "🚂", "🚲"]}, {"text": "Profissão que cuida da saúde", "targets": ["👩‍⚕️", "👨‍⚕️", "🩺"], "decoys": ["👮", "👷", "👩‍🏫", "👨‍🍳", "👩‍🎤", "👨‍🎨", "👩‍🚀", "👨‍🚒", "👩‍⚖️"]}, {"text": "Comida de fast food", "targets": ["🍔", "🍟", "🍕"], "decoys": ["🥗", "🍎", "🥦", "🥕", "🍉", "🍇", "🍓", "🍈", "🍒"]}, {"text": "Objeto que você usa no rosto para enxergar", "targets": ["👓", "🕶️", "🥽"], "decoys": ["🧢", "👒", "🎓", "👑", "💍", "🧣", "🧤", "🧦", "👟"]}, {"text": "Bolas usadas em esportes", "targets": ["⚽", "🏀", "🏐"], "decoys": ["🏊", "🏃", "🚴", "🏋️", "🤸", "🤼", "🧗", "🤺", "🏇"]}, {"text": "Lugar onde as pessoas vão para rezar ou orar", "targets": ["⛪", "🕌", "🕍"], "decoys": ["🏦", "🏥", "🏨", "🏪", "🏫", "🏬", "🏭", "🏯", "🏰"]}, {"text": "Objeto usado para trancar portas", "targets": ["🔒", "🔐", "🔑"], "decoys": ["🔓", "🗡️", "🔫", "💣", "🪓", "🧨", "🛡️", "🚬", "⚰️"]}, {"text": "Inseto que voa e pousa em flores", "targets": ["🦋", "🐝", "🐞"], "decoys": ["🐜", "🕷️", "🦂", "🦟", "🦗", "🐛", "🐌", "🦞", "🦀"]}, {"text": "Bebida que se toma de manhã", "targets": ["☕", "🥛", "🧃"], "decoys": ["🍺", "🍷", "🥂", "🥃", "🍸", "🍹", "🧉", "🍾", "🧊"]}, {"text": "Símbolo de amor ou paixão", "targets": ["❤️", "💘", "🌹"], "decoys": ["💔", "🖤", "☠️", "💩", "👽", "👾", "🤖", "🎃", "😈"]}, {"text": "Símbolo de riqueza ou tesouro", "targets": ["💰", "💎", "👑"], "decoys": ["🗑️", "🧾", "📉", "🛒", "📦", "🧹", "🧻", "🚽", "🪠"]}, {"text": "Fruta cítrica e azeda", "targets": ["🍋", "🍊", "🍍"], "decoys": ["🍎", "🍌", "🍉", "🍇", "🍓", "🍈", "🍒", "🍑", "🥭"]}, {"text": "Algo que pode causar fogo ou explosão", "targets": ["🔥", "💣", "🧨"], "decoys": ["💧", "🌊", "❄️", "🧊", "⛄", "🌧️", "⛈️", "🌩️", "🌪️"]}, {"text": "Usado para consertar ou construir coisas", "targets": ["🔨", "🔧", "🪛"], "decoys": ["🧸", "🎈", "🪄", "🎁", "🎊", "🎉", "🎎", "🎏", "🎐"]}, {"text": "Usado para escrever ou desenhar", "targets": ["✏️", "✒️", "🖍️"], "decoys": ["✂️", "📏", "📎", "🧲", "🧮", "🗑️", "📦", "📱", "💻"]}],
  ...
  createModal: function() {
    ...
    style.textContent = `
      ...
      .caju-item { aspect-ratio: 1; display:flex; justify-content:center; align-items:center; font-size:45px; cursor:pointer; background:#fff; border: 1px solid #d1d5db; border-radius:4px; transition:all 0.15s; user-select:none; box-shadow: 0 1px 2px rgba(0,0,0,0.05); overflow:hidden; }
